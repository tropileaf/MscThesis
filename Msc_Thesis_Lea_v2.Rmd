...
+ EBSAs
+ Deepsea features: active vents, seamounts, plateaus?
...
Seamounts,plateaus, vents

*need to cross vents with PUs*
...
VentsActiveSF<- st_as_sf(VentsActive, coords = c("Latitude", "Longitude"), crs = st_crs(PUs))
...
ggplot() + 
  ...
  scale_color_manual(values = c("A" = "orange", "B" = "brown", "C" = "red", "D" = "red"), 
                     labels = c("CFC", "PMN", "Exploration areas", "Reserved areas"),
                     name = "Legend") +
